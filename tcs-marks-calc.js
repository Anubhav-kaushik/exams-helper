...
function getQuestionDetails(quesRow) {
    ...
    for (let row of allQuesRows) {
        ...
        for (let data of rowData) {
            ...
            else if (data.innerText.length <= 20) {
                if (data.innerText.includes('Ans')) break;
                else if (data.innerText.includes('Q.') || data.innerText.includes('Question')) continue;
            }
            else if (data.classList.contains('rightAns') || data.classList.contains('wrngAns')) break;
